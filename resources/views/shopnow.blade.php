...
<body class="bg-light text-dark font-sans relative">
...
<header class="bg-light shadow-sm sticky top-0 z-50  bg-opacity-7">
 ...
 <section class="py-16 bg-gradient-to-br from-light to-dark">
  ...
  <!-- Popup Overlay -->
  <div id="signupPopup" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <!-- Popup Content -->
    <div class="bg-white rounded-xl p-8 max-w-md w-full mx-4 relative transform transition-all duration-300 scale-95 opacity-0" id="popupContent">
      ...
      <div class="text-center">
        <!-- Paw Icon -->
        <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-light flex items-center justify-center mx-auto mb-4 shadow-md">
          <span class="text-white text-2xl">🐾</span>
        </div>
        
        <!-- Title -->
        <h3 class="text-2xl font-bold text-dark mb-3 font-display">Join the PawMart Family!</h3>
        
        <!-- Message -->
        <p class="text-gray-600 mb-6">Join us before your first order – it's quick and easy!</p>
 ...
 <footer class="bg-gray-900 text-white py-12">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const joinBtn = document.getElementById('joinNowButton');
