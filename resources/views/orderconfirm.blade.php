...
<section class="py-16 bg-light min-h-screen flex items-center">
  <div class="max-w-lg mx-auto bg-white rounded-2xl shadow-xl p-8 text-center">
    ...
    <h1 class="text-3xl font-display font-bold text-primary mb-4">Order Confirmed!</h1>
    <p class="mb-6">Thank you for your purchase. Your order <span class="font-semibold">#PAW12345</span> has been received.</p>
    ...
    <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left">
      ...
      <div class="flex justify-between py-2">
        ...
        <span class="font-medium">June 18-20, 2023</span>
      </div>
    </div>

    <div class="space-y-3">
      <a href="/account/orders" class="block bg-accent hover:bg-accent/90 text-white font-bold py-3 px-4 rounded-lg transition">
        View Order Details
      </a>
      <a href="/products" class="block border border-primary text-primary hover:bg-primary/5 font-bold py-3 px-4 rounded-lg transition">
        Continue Shopping
      </a>
    </div>
