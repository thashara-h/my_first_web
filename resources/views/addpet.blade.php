            ...
            <form method="post" action="{{route('AddPet')}}">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input x-model="newPet.name" type="text" name="pet_name" value="{{old('pet_name')}}" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petpurple">
                        @error('pet_name')
                    ...
                    <div>
                        ...
                        <select x-model="newPet.type" required name="pet_type" value="{{old('pet_type')}}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petpurple">
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input x-model="newPet.age" type="number" name="age" value="{{old('age')}}" min="0" required
                    ...
                    <div>
                        ...
                        <select x-model="newPet.healthStatus" required name="health_status" value="{{old('health_status')}}"
