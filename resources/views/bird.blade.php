  ...
  <div class="max-w-8xl mx-auto px-6 py-3 flex justify-between items-center">
    ...
    <nav class="hidden lg:block">
      <ul class="flex space-x-10">
        ...
        <li>
          <a href="products.html" class="relative px-2 py-1 text-gray-700 hover:text-purple-600 font-medium transition-all group">
            <span>Products</span>
            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-purple-500 transition-all group-hover:w-full"></span>
          </a>
        </li>
    ...
    <div class="max-w-7xl mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center">
      ...
      <div class="md:w-1/2" data-aos="fade-left">
        <div class="relative">
          ...
          <img src="C:\Users\kulat\Downloads\download (1).png"
        ...
        <div class="mt-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1583337130417-3346a1be7dee?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
                             alt="Dog Treats" 
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1591769225440-811ad7d6eab2?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
                             alt="Puppy Food" 
                             class="w-full h-48 object-cover">
                    </div>
                    <div class="p-4">
    ...
    <div class="max-w-7xl mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center">
      ...
      <div class="md:w-1/2" data-aos="fade-left">
        <div class="relative">
          ...
          <div class="absolute -bottom-6 -right-6 w-64 h-64 bg-primary rounded-2xl opacity-20"></div>
          <img src="C:\Users\kulat\Downloads\download45.png"
               alt="Happy dog with toys" 
               class="relative rounded-2xl shadow-xl w-full max-w-lg mx-auto" />
        </div>
      </div>
