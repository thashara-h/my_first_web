                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Manage Other Food</h2>
                            <a href="/addOtherFood" class="bg-petpurple hover:bg-purple-700 text-white px-4 py-2 rounded-lg flex items-center">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                ...
                                <tbody>
                                    @if(count($all_otherfood)>0)
                                      @foreach($all_otherfood as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('otherfood.edit', $item->id) }}" class="text-blue-600 hover:text-blue-800">Edit</a></td>
                                            <td>
                                            <form action="{{ route('otherfood.delete', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
