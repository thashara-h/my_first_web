...
<body class="bg-light text-dark font-sans">
  ...
  <!-- Hero Section -->
  <section class="py-16 bg-gradient-to-br from-dark to-light">
    <div class="max-w-7xl mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center">
      <div class="md:w-1/2 mb-12 md:mb-0" data-aos="fade-right">
        <h2 class="text-4xl md:text-5xl font-display font-bold leading-tight mb-6 text-accent">
         Delicious Grain-Free Recipes for Sensitive Tummies!
        </h2>
      ...
      <div class="md:w-1/2" data-aos="fade-left">
        <div class="relative">
          ...
          <img src="{{ asset('images/dogfood.png') }}"
        ...
        <div class="mt-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="{{ asset('dogfooditem/1.jpeg') }}"
                             alt="Dog Treats" 
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="{{ asset('dogfooditem/2.jpeg') }}" 
                             alt="Puppy Food" 
                             class="w-full h-48 object-cover">
                    </div>
                    <div class="p-4">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="{{ asset('dogfooditem/3.jpeg') }}" 
                             alt="Dog Treats" 
                             class="w-full h-48 object-cover">
                        <span class="absolute top-2 right-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full">SALE</span>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="{{ asset('dogfooditem/5.jpeg') }}" 
                             alt="Dog Treats" 
                             class="w-full h-48 object-cover">
                        <span class="absolute top-2 right-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full">SALE</span>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="{{ asset('dogfooditem/6.jpeg') }}" 
                             alt="Puppy Food" 
                             class="w-full h-48 object-cover">
                    </div>
                    <div class="p-4">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                    <div class="relative">
                        <img src="{{ asset('dogfooditem/7.jpeg') }}" 
                             alt="Dog Treats" 
                             class="w-full h-48 object-cover">
                        <span class="absolute top-2 right-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full">SALE</span>
                    </div>
