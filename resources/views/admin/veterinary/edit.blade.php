    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <form action="{{ route('admin.veterinary.update', $appointment->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('admin.veterinary.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Cancel
                        </a>
